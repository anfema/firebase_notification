"""
Django settings for example_proj project.
...
SECRET_KEY = 'django-insecure-4wjti2dgv7j#*q_x7fzrvwbu%c)ut@je)*=hn*h8-8eny07qt&'
...
# Import settings_local.py (if it exists) to load local settings overrides
try:
